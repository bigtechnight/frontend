...
const LightRay = React.memo<LightRayProps>(
    ({
        ...
        return (
            <motion.div
                className="absolute pointer-events-none -top-[5%] left-[var(--ray-left)] w-[var(--ray-width)] h-[var(--ray-height)] origin-top mix-blend-screen bg-[linear-gradient(to_bottom,rgba(127,95,255,var(--ray-opacity)),rgba(127,95,255,0))] blur-[var(--ray-blur)] translate-x-[-50%] rotate-[var(--ray-rotation)]"
                style={
                    {
                        '--ray-left': left,
                        '--ray-width': `${width}px`,
